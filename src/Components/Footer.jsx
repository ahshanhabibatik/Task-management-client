...
const Footer = () => {
  return (
    <footer>
        ...
        <div class="container px-4 mx-auto">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
              <div className="flex ml-2 font-serif">
                <span className="lg:text-2xl font-bold mr-1 lg:mr-2">
                  <img
                    className="w-8"
                    src="https://i.ibb.co/xXK8JbY/46cd20a33efe24abce136ee09cea122a-removebg-preview.png"
                    alt="logo"
                  />{" "}
                </span>{" "}
                <span className="text-white mt-1.5 font-bold lg:text-2xl">
                  ACC Tech
                </span>
              </div>
              <p class="text-justify">
                It is a collection of UI Components created using Tailwind CSS
                Framework. The UI Components gives you all of the building
            ...
            <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              ...
              <a
                href="https://www.facebook.com/ahshanhabib.atik/"
              ...
              <a
                href="https://github.com/ahshanhabibatik"
                class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400"
              >
                <svg
                  class="w-4 h-4 fill-current"
      ...
      <div class="bg-lime-600 py-4 text-gray-100 flex justify-center">
        <div class="px-4 w-full sm:w-auto sm:text-left">
          Copyright © 2020
          <script>
            new Date().getFullYear() > 2020 && document.write("- " + new
            Date().getFullYear())
          </script>
          - 2022 ACC Task. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
